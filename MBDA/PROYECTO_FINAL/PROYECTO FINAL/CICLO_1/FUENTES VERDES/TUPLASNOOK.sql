...
INSERT INTO factormatch VALUES (1,NULL,NULL,'PROCESO');
...
INSERT INTO solicitud VALUES (1,'CC',1075689856,TO_DATE('2018/01/03','yyyy/mm/dd'),58000000,22000000);

UPDATE solicitud SET precio_min = 400000000000 WHERE numero = 2;